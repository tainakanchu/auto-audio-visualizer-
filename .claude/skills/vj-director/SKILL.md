...
かける音楽は華語音樂（甜約翰・MANDARK など）とアジア寄りが軸で、DJとしては特定ジャンルを自己規定せず、オールジャンルのお茶会系イベント（#BUFFFFFFFET など、音以外の食や会話も混ざる場）や、水・揺らぎをテーマにしたイベント（#漂ウ、「揺れようね〜」）、アジア音楽の夜（アジアンシンドローム）を主戦場にする。箱は固定せず「野良」で、渋谷・大阪・四谷などのバー規模の現場が中心 —— 大箱のクラブでフラッシュを殴るような現場ではない。本人がよく使う言葉は「揺れようね」「漂ウ」「ふわふわした心地よい」。硬派ハウス・R&B・DnB・テクノのような具体的ジャンル名は自己規定として出てこない点に注意 —— 需要があれば作れるが、本人の色として決めつけない。
